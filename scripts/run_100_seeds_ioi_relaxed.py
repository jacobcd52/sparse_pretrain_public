...
from sparse_pretrain.src.pruning.tasks import get_task, IOIRelaxedTask
...
class IOIRelaxedSameGenderTask(IOIRelaxedTask):
    ...
    def generate_example(self):
        from sparse_pretrain.src.pruning.tasks import TaskExample
...
def main():
    # Configuration
    CHECKPOINT_DIR = Path("outputs/carbs_results_ioi_relaxed/ss_bridges_d1024_f0.015625_zero_noembed")
    NUM_SEEDS = 100
    DEVICE = "cuda"
