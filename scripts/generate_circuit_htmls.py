#!/usr/bin/env python3
"""
Generate circuit HTML visualizations for all ss_ models in carbs_results_pronoun.

This script loads the best checkpoint from each model and generates
an interactive HTML circuit visualization.

Usage:
    python my_sparse_pretrain/scripts/generate_circuit_htmls.py
"""
