#!/usr/bin/env python
"""
Run CARBS sweep for d1024 model on the "when" task (control).
Target: always predict "when" regardless of context.

Results saved to carbs_results_pronoun_when/
"""
...
def main():
    ...
    print("Task: dummy_pronoun_when (CONTROL - always predict 'when')")
    ...
    # Create config for the "when" task
    config = CleanSweepConfig(
        model_path="jacobcd52/ss_bridges_d1024_f0.015625",
        tokenizer_name="SimpleStories/SimpleStories-1.25M",
        task_name="dummy_pronoun_when",  # The new control task
        num_runs=32,
    ...
    # The output dir will be: carbs_results_pronoun_when/ss_bridges_d1024_f0.015625_zero_noembed
